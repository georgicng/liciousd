            ...
            >
                ...
                <div class="flex gap-2.5 mt-3.5">
                    ...
                    <div class="flex flex-col flex-1 gap-2 overflow-auto">
                        ...
                        <!-- Options -->
                        <div
                            class="p-4 bg-white dark:bg-gray-900 box-shadow rounded {{ in_array($option->type, ['select', 'multiselect', 'checkbox', 'price']) ?: 'hidden' }}"
                            v-if="showSwatch"
                        >
                                ...
                                <div class="flex gap-4 items-center max-sm:flex-wrap">
                                    ...
                                    <div class="w-full">
                                        ...
                                        <div class="flex gap-2.5 items-center w-max !mb-0 cursor-pointer select-none">
                                            ...
                                            <label
                                                for="empty_option"
                                                class="text-xs text-gray-600 dark:text-gray-300 font-semibold cursor-pointer"
                                            >
