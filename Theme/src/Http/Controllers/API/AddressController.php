...
use Gaiproject\Theme\Http\Requests\Customer\AddressRequest;
use Gaiproject\Theme\Http\Resources\AddressResource;
...
class AddressController extends APIController
{
    ...
    public function store(AddressRequest $request): JsonResource
    {
        ...
        return new JsonResource([
            ...
            'message' => trans('licious::app.customers.account.addresses.create-success'),
        ]);
    }
