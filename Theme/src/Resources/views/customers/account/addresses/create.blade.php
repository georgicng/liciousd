<x-licious::layouts.account>
    ...
    <!-- Breadcrumbs -->
    @section('breadcrumbs')
        <x-licious::breadcrumbs name="addresses.create" />
    @endSection
    ...
    @push('scripts')
        <script type="text/x-template" id="v-create-customer-address-template">
            <div>
                <x-licious::form :action="route('shop.customers.account.addresses.store')">
                    ...
                    <x-licious::form.control-group>
                        <x-licious::form.control-group.label class="required">
                            @lang('licious::app.customers.account.addresses.email')
                        </x-licious::form.control-group.label>
                        ...
                        <x-licious::form.control-group.control
                            ...
                            :value="old('email')"
                            :label="trans('licious::app.customers.account.addresses.email')"
                            :placeholder="trans('licious::app.customers.account.addresses.email')"
                        />
                    ...
                    <x-licious::form.control-group>
                        ...
                        >
                            <option value="">
                                @lang('licious::app.customers.account.addresses.select-country')
                            </option>
