@component('shop::emails.layout')
    <div style="margin-bottom: 34px;">
        ...
        <p style="font-size: 16px;color: #384860;line-height: 24px;">
            @lang('licious::app.emails.customers.subscribed.greeting')
        </p>
    </div>

    <p style="font-size: 16px;color: #384860;line-height: 24px;margin-bottom: 40px">
        @lang('licious::app.emails.customers.subscribed.description')
    </p>
    ...
    <div style="display: flex;margin-bottom: 95px">
        ...
        >
            @lang('licious::app.emails.customers.subscribed.unsubscribe')
        </a>
    </div>
@endcomponent
