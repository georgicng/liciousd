    ...
    @case('number')
        ...
        >
            <input
                ...
                {{ $attributes->except(['value', ':value', 'v-model', 'rules', ':rules', 'label', ':label'])->merge(['class' => 'w-full h-[50px] px-[15px] border-[1px] border-solid border-[#e9e9e9] rounded-[5px] outline-[0]']) }}
            >
        </v-field>
