        ...
        <div class="cr-cat-tab flex">
            <ul class="cr-tab-list nav flex-column nav-pills min-w-[180px] mr-[12px] rounded-[5px] flex flex-wrap flex-col justify-center" id="myTab">
                <li class="transition-all duration-[0.3s] ease-in-out py-[10px] px-[15px] bg-[#fff] border-[1px] border-solid border-[#e9e9e9] rounded-[5px] flex items-center cursor-pointer mb-[5px]">
                    <a role="button" class="text-[13px] text-[#4b5966] tracking-[0] font-medium text-left capitalize w-full" @click="change(0)">Dairy &amp; Bakery</a>
                </li>
                <li class="transition-all duration-[0.3s] ease-in-out py-[10px] px-[15px] bg-[#fff] border-[1px] border-solid border-[#e9e9e9] rounded-[5px] flex items-center cursor-pointer mb-[5px]">
                    <a role="button" class="text-[13px] text-[#4b5966] tracking-[0] font-medium text-left capitalize w-full" @click="change(1)">Fruits &amp; Vegetable</a>
                </li>
                <li class="transition-all duration-[0.3s] ease-in-out py-[10px] px-[15px] bg-[#fff] border-[1px] border-solid border-[#e9e9e9] rounded-[5px] flex items-center cursor-pointer mb-[5px]">
                    <a role="button" class="text-[13px] text-[#4b5966] tracking-[0] font-medium text-left capitalize w-full" @click="change(2)">Snack &amp; Spice</a>
                </li>
                <li class="transition-all duration-[0.3s] ease-in-out py-[10px] px-[15px] bg-[#fff] border-[1px] border-solid border-[#e9e9e9] rounded-[5px] flex items-center cursor-pointer mb-[5px]">
                    <a role="button" class="text-[13px] text-[#4b5966] tracking-[0] font-medium text-left capitalize w-full" @click="change(3)">Juice &amp; Drinks</a>
                </li>
            </ul>
