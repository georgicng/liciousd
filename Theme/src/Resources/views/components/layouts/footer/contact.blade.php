<div class="cr-footer">
    ...
    <ul class="cr-footer-links max-[991px]:hidden cr-footer-dropdown max-[1199px]:max-w-[500px] max-[991px]:mt-[24px]">
        <li class="location-icon font-Poppins mb-[12px] text-[14px] leading-[26px] text-[#777] relative mt-[24px] pl-[30px] max-[1399px]:mt-[20px] mt-[-5px] mb-[12px]">
            {{ core()->getConfigData('store.information.bio.address') }}
        </li>
        <li class="mail-icon mb-[12px] font-Poppins text-[14px] leading-[26px] text-[#777] relative pl-[30px] max-[1399px]:mt-[20px] max-[991px]:mt-[15px]">
            <a href="javascript:void(0)" class="transition-all duration-[0.3s] ease-in-out relative font-Poppins text-[14px] leading-[26px] text-[#777] hover:text-[#64b496]">{{ core()->getConfigData('store.information.bio.email') }}</a>
        </li>
        <li class="phone-icon font-Poppins text-[14px] leading-[26px] text-[#777] relative pl-[30px] mb-[0] max-[1399px]:mt-[20px] max-[991px]:mt-[15px]">
            <a href="javascript:void(0)" class="transition-all duration-[0.3s] ease-in-out relative font-Poppins text-[14px] leading-[26px] text-[#777] hover:text-[#64b496]">{{ core()->getConfigData('store.information.bio.phone') }}</a>
        </li>
    </ul>
</div>
