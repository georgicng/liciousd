<v-image-search-result-component>
    <div class="mt-8 p-5 border border-gray-200 rounded-lg">
        <div class="flex gap-12">
            <x-licious::media.images.lazy class="max-w-[110px] max-h-[110px] min-w-[110px] w-[110px] h-[110px] rounded-sm" />
            ...
            <div class="flex gap-12">
                ...
                <div class="flex flex-col gap-4">
                    <h2 class="text-2xl font-medium">
                        @lang('licious::app.search.images.results.analysed-keywords')
                    </h2>
