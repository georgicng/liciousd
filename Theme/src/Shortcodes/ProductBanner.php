...
class ProductBanner extends Shortcode
{
    /**
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.product-banner'), $this->attributes ?: []));
    }
}
