...
class NewProduct extends Shortcode
{
    /**
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.new-product'), $this->attributes ?: []));
    }
}
