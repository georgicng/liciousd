...
class Columns extends Shortcode
{
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.columns.index'), [ ...($this->attributes ?: []), 'slot' => $this->body]));
    }
}
