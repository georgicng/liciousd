...
class Faq extends Shortcode
{
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.faqs.item'), [ ...($this->attributes ?: []), 'answer' => $this->body ]));
    }
}
