...
class Services extends Shortcode
{
    /**
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.services'), $this->attributes ?: []));
    }
}
