...
class PopularProduct extends Shortcode
{
    /**
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.popular-product'), $this->attributes ?: []));
    }
}
