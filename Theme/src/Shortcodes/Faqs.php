...
class Faqs extends Shortcode
{
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.faqs.index'), [ ...($this->attributes ?: []), 'slot' => $this->body ]));
    }
}
