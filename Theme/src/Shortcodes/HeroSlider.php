...
class HeroSlider extends Shortcode
{
    /**
    ...
    {
        return Blade::renderComponent(new AnonymousComponent(view('licious::components.shortcodes.hero-slider'), $this->attributes ?: []));
    }
}
